...
String City             = "Chiang Mai";                      // Your home city See: http://bulk.openweathermap.org/sample/
String Country          = "TH";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
...
const char* Timezone    = "<+07>-7,M3.5.5/0,M10.5.5/0";  // Choose your time zone from: https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv 
...
int   gmtOffset_sec     = 25200;    // UK normal time is GMT, so GMT Offset is 0, for US (-5Hrs) is typically -18000, AU is typically (+8hrs) 28800
